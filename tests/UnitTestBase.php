...
abstract class UnitTestBase extends PHPUnit_Framework_TestCase
{
    ...
    protected function fireSingleValueTest($verifyMethod, $assertMethod)
    {
        ...
        $this->assertNull(call_user_func(static::$verifyMethod, 'subject 1')->$verifyMethod());
        $this->assertNull(call_user_func(static::$verifyMethod, 'message', 'subject 2')->$verifyMethod());
    }
    ...
    protected function fireTwoValueTest($verifyMethod, $assertMethod)
    {
        ...
        $this->assertNull(call_user_func(static::$verifyMethod, 'subject 1')->$verifyMethod('test 1'));
        $this->assertNull(call_user_func(static::$verifyMethod, 'message', 'subject 2')->$verifyMethod('test 2'));
    }
}
